      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <ScrollReveal delay={50} direction="up">
            <div className="h-full p-6 rounded-2xl border border-white/10 bg-slate-950/80 flex flex-col justify-between hover:border-violet-500/30 transition-all group shadow-xl">
              <div>
          ...
          <ScrollReveal delay={120} direction="up">
            <div className="h-full p-6 rounded-2xl border border-white/10 bg-slate-950/80 flex flex-col justify-between hover:border-sky-500/30 transition-all group shadow-xl">
              <div>
          ...
          <ScrollReveal delay={190} direction="up">
            <div className="h-full p-6 rounded-2xl border border-white/10 bg-slate-950/80 flex flex-col justify-between hover:border-emerald-500/30 transition-all group shadow-xl">
              <div>
          ...
          <ScrollReveal delay={330} direction="up">
            <div className="h-full p-6 rounded-2xl border border-white/10 bg-slate-950/80 flex flex-col justify-between hover:border-amber-500/30 transition-all group shadow-xl">
              <div>
          ...
          <ScrollReveal delay={400} direction="up">
            <div className="h-full p-6 rounded-2xl border border-white/10 bg-slate-950/80 flex flex-col justify-between hover:border-red-500/30 transition-all group shadow-xl">
              <div>
