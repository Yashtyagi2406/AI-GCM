      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <ScrollReveal delay={100} direction="up">
            <div className="h-full p-7 rounded-2xl border border-white/10 bg-slate-950/80 backdrop-blur-sm hover:border-red-500/30 transition-all flex flex-col justify-between group shadow-xl">
              <div>
          ...
          <ScrollReveal delay={200} direction="up">
            <div className="h-full p-7 rounded-2xl border border-white/10 bg-slate-950/80 backdrop-blur-sm hover:border-amber-500/30 transition-all flex flex-col justify-between group shadow-xl">
              <div>
                <div className="flex items-center justify-between mb-4">
          ...
          <ScrollReveal delay={300} direction="up">
            <div className="h-full p-7 rounded-2xl border border-white/10 bg-slate-950/80 backdrop-blur-sm hover:border-sky-500/30 transition-all flex flex-col justify-between group shadow-xl">
              <div>
                <div className="flex items-center justify-between mb-4">
          ...
          <ScrollReveal delay={400} direction="up">
            <div className="h-full p-7 rounded-2xl border border-white/10 bg-slate-950/80 backdrop-blur-sm hover:border-violet-500/30 transition-all flex flex-col justify-between group shadow-xl">
              <div>
                <div className="flex items-center justify-between mb-4">
